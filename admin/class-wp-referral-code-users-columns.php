...
class WP_Referral_Code_Users_Columns {
	...
	public function load_users_table() {
		add_filter( 'manage_users_columns', [ $this, 'add_invite_count_col' ], 100, 1 );
		add_filter( 'manage_users_columns', [ $this, 'add_invited_by_col' ], 100, 1 );

		add_filter( 'manage_users_custom_column', [ $this, 'fill_cells' ], 100, 3 );
	}
